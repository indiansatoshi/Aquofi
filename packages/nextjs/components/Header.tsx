...
import { BanknotesIcon, Bars3Icon, BellAlertIcon, BugAntIcon, HomeIcon, MagnifyingGlassIcon, MusicalNoteIcon, NewspaperIcon, PaintBrushIcon, PaperAirplaneIcon, PaperClipIcon, PlayCircleIcon, PlayIcon, ShareIcon } from "@heroicons/react/24/outline";
